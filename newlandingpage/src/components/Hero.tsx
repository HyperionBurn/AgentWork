  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto w-full z-10 flex flex-col items-center text-center mt-20">
        ...
        >
          <MagneticButton intensity={0.3} className="bg-orange-600 hover:bg-orange-500 text-white rounded-full px-8 py-4 text-sm font-medium transition-all shadow-[0_0_30px_-5px_rgba(249,115,22,0.4)] flex items-center gap-2 group">
            Deploy Smart Agent
